...
for (id in unique(df_all$panel_id)) {
  ...
  if(id == "(a)"){
    custom_breaks <- c(1.01, 1.015, 1.02, 1.03)
  } else if(id == "(b)"){
    custom_breaks <- c(1.01, 1.02, 1.03)
  } else if(id == "(c)"){
    custom_breaks <- c(1.005, 1.015, 1.02)
  } else if(id == "(d)"){
    custom_breaks <- c(1.002, 1.010)
  }
...
pdf("../figures/figure_power_ratio_0.3.pdf", width = 12, height = 10, paper = "special")
